...
export function activate(context: vscode.ExtensionContext) {
  ...
  let disposable = vscode.commands.registerCommand(
    ...
    async () => {
      ...
      // 2. crawl random twitter https://twitter.com/natureamazin and display progressbar https://github.com/microsoft/vscode-extension-samples/tree/master/progress-sample
